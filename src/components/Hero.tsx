      ...
      <div className="relative z-10">
        ...
        >
          <div className="relative" style={{ perspective: '1000px' }}>
            <div className="absolute inset-0 bg-yellow-500 blur-xl opacity-50 rounded-full animate-pulse" style={{ width: '192px', height: '192px', left: '50%', top: '50%', transform: 'translate(-50%, -50%)' }} />
            <motion.img 
              src={logo} 
              alt="BattleRoyal.fun Logo" 
              className="w-48 h-48 relative z-10 drop-shadow-[0_0_15px_rgba(250,204,21,0.8)] object-contain"
              style={{ 
